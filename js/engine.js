var startEngine = function() {
  ...
  var Engine = (function(global) {
      ...
      var doc = global.document,
          ...
          buttons and inside the main tag */
          canContainer = document.getElementById('canvas-container'),
      ...
      function renderEntities() {
          ...
          allHearts.forEach(function(life) {
              life.render();
          });

          allWater.forEach(function(water) {
              water.render();
          });

          allGemScores.forEach(function(gemScore) {
              gemScore.render();
          });
